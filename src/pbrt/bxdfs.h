...
#undef interface
    ...
    SampledSpectrum Max_f(Vector3f wo, DirectionCone wiCone,
        ...
        //
        //// Determine entrance interface for layered BSDF
        //TopOrBottomBxDF<TopBxDF, BottomBxDF> enterInterface, otherInterface;
        //if (enteredTop) {
        //    enterInterface = &top;
        //    otherInterface = &bottom;
        //} else {
        //    enterInterface = &bottom;
        //    otherInterface = &top;
        //}
        //
        //TopOrBottomBxDF<TopBxDF, BottomBxDF> exitSame = enterInterface;
        //TopOrBottomBxDF<TopBxDF, BottomBxDF> exitDiff = otherInterface;
        //TopOrBottomBxDF<TopBxDF, BottomBxDF> nonExitSame = otherInterface;
        //TopOrBottomBxDF<TopBxDF, BottomBxDF> nonExitDiff = enterInterface;
        //
        //DirectionCone entireSphere = DirectionCone::EntireSphere();
        //
        //SampledSpectrum layeredMax(0.f);
        //SampledSpectrum enterTransmissionAll =
        //    enterInterface.Max_f(wo, entireSphere, mode, BxDFReflTransFlags::Transmission);
        //
        //SampledSpectrum exitSameTransmission(0.f), exitDiffTransmission(0.f);
        //if (enterTransmissionAll) {
        //    exitSameTransmission = 
        //        exitSame.Max_f({0, 0, 1}, entireSphere, mode, BxDFReflTransFlags::Transmission);
        //    exitDiffTransmission = 
        //        exitDiff.Max_f({0, 0, 1}, entireSphere, mode, BxDFReflTransFlags::Transmission);
        //}
        //
        //const bool hasExitSameTransmission = exitSameTransmission;
        //const bool hasExitDiffTransmission = exitDiffTransmission;
        //
        //Float hgMax = 0;
        //if (albedo) {
        //    hgMax = HenyeyGreenstein(1, std::abs(g));
        //}
        //
        //if ((flags & BxDFReflTransFlags::Reflection) && (h & HemisphereIntersection::SAME)) {
        //    layeredMax.MixMax(enterInterface.Max_f(wo, wiCone, mode, BxDFReflTransFlags::Reflection));
        //
        //    SampledSpectrum nonExitRefl =
        //        nonExitSame.Max_f({0, 0, 1}, entireSphere, mode, BxDFReflTransFlags::Reflection);
        //    const bool hasNonExitRefl = nonExitRefl;
        //
        //    if (hasExitSameTransmission && hasNonExitRefl)
        //        layeredMax.MixMax(
        //            enterTransmissionAll * nonExitRefl * exitSameTransmission);
        //
        //    if (hasExitSameTransmission && hgMax > 0) {
        //        layeredMax.MixMax(
        //            enterTransmissionAll * exitSameTransmission * albedo * hgMax);
        //    }
        //        
        //}
        //
        //if ((flags & BxDFReflTransFlags::Transmission) && (h & HemisphereIntersection::DIFF)) {
        //    if (hasExitDiffTransmission && hgMax > 0) {
        //        layeredMax.MixMax(
        //            enterTransmissionAll * exitDiffTransmission * albedo * hgMax);
        //    }
        //}
        //
        //return layeredMax;
